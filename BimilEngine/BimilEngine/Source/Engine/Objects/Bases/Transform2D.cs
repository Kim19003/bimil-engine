...
namespace BimilEngine.Source.Engine.Objects.Bases
{
    public abstract class Transform2D
    {
        ...
        public Transform2D(Vector2 position, Vector2 scale, int cameraLevel = 0, string name = "", string tag = "", Scene2D associatedScene = null)
        {
            Name = name;
            Tag = tag;
            Position = /*ConvertUnits.ToSimUnits(*/position/*)*/;
            Scale = /*ConvertUnits.ToSimUnits(*/scale/*)*/;
