...
namespace BimilEngine.Source.Engine.Other
{
    ...
    public static class SpriteBatchExtensions
    {
        ...
        public static void DrawLine(this SpriteBatch spriteBatch, LineDrawShape lineDrawShape)
        {
            ...
            spriteBatch.Draw(Globals.PixelTexture, lineDrawShape.Start, null, lineDrawShape.Color, angle, Vector2.Zero, new Vector2(edge.Length(),
